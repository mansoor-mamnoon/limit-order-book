...
install({'python.cli': '/Users/muneermamnoon/GitHub Projects/limit-order-book/python/cli.py', 'python.lob': '/Users/muneermamnoon/GitHub Projects/limit-order-book/python/lob/__init__.py', 'python.lob._bindings': '/Users/muneermamnoon/GitHub Projects/limit-order-book/python/lob/_bindings.cpp'}, {'lob._lob': 'lob/_lob.cpython-311-darwin.so', 'bin.replay_tool': 'bin/replay_tool', 'bin.bench_tool': 'bin/bench_tool'}, None, False, True, ['-v'], [], '')
